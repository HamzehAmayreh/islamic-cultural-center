...
public class InstructorRestController {
    ...
    public ResponseEntity<Response<List<InstructorStudentResponseDto>>> viewStudentsOfCourse(@PathVariable Long id){
        Response<List<InstructorStudentResponseDto>> response= Response.<List<InstructorStudentResponseDto>>builder()
                .data(instructorCoursesService.getStudentsByCourseId(id))
                .code(CODE.OK.getId())
                .message(CODE.OK.name())
                .success(true)
                .build();
